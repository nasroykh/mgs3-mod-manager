...
This text is ready to share after choosing the audience and checking the community's posting rules. It has not been posted or sent to anyone automatically.
...
Please use your own game and original Nexus download. Crouch Walk is not bundled, and its archive/generated package should not be redistributed. Keep saves backed up privately, close the game before manager changes, and do not downgrade to v0.1.0 after importing Crouch Walk.

Success reports are useful too. Tell me your game/store version, Windows version, input device, other mods, and which checklist items passed, failed, or were not tested. Review and redact diagnostics before posting; no game files, saves, private paths, or full crash dumps, please.
